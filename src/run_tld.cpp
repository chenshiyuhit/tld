...
int main(int argc, char * argv[]){
    ...
    ros::NodeHandle csy;
    ros::Publisher pose_pub = csy.advertise<geometry_msgs::Pose2D>("TLDpose",100);
...
//  cout<<"===================="<<capture.get(CV_CAP_PROP_FRAME_WIDTH)<<"*"<<capture.get(CV_CAP_PROP_FRAME_HEIGHT)<<"  "<<capture.get(CV_CAP_PROP_FPS)<<endl;
...
//      ostringstream printText1;
//      printText1<<"FPS:"<<capture.get(CV_CAP_PROP_POS_MSEC);
//      putText(frame,printText1.str(),Point(20,20),FONT_HERSHEY_SIMPLEX,0.6,CV_RGB(255,255,0),2);
